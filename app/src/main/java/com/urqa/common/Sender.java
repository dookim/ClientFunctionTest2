...
public class Sender {
    ...
    public static void sendSession(Authentication auth, String url)
    {
        ...
        network.setNetworkOption(url, auth.toJSONObject().toString(), Network.Method.POST, true);
        network.start();
    }
    ...
    public static void sendException(ErrorReport report, String url)
        ...
        Network network = new Network();
        network.setNetworkOption(url, makeJsonStr(report), Network.Method.POST, true);
